...
export const timeline=({Rocket,Earth,RocketLayer,LevelDesc}:TimelineProps)=>{
    ...
    // .add(level3({RocketLayer:RocketLayer[2],LevelDesc:LevelDesc[2]}))
    // .add(level4({RocketLayer:RocketLayer[3],LevelDesc:LevelDesc[3]}))
